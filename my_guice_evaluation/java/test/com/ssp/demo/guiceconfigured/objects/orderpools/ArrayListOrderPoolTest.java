...
/**
 * <p>
 * ArrayListOrderPoolTest provides methods to test the ArrayListOrderPool class.
 * </p>
 * Copyright 2014 SSI Schaefer PEEM GmbH. All rights reserved.
 */

public class ArrayListOrderPoolTest {
  ...
  public final void test() throws Exception {
    ...
    assertEquals(Integer.valueOf(config.getInt("pool.initialSize")), Integer.valueOf(pool.getInitialSize()));
  }

}

//---------------------------- Revision History ----------------------------
//$Log: ArrayListOrderPoolTest.java,v $
