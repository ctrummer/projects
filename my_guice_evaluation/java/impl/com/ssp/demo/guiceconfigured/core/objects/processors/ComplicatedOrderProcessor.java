...
/**
 * <p>
 * ComplicatedOrderProcessor provides a processor to process complicated orders.
 * </p>
 * <p>
 * ComplicatedOrderProcessor is immutable and may be freely exchanged between threads. <br />
 * Calls to methods of ComplicatedOrderProcessor are thread safe.
 * </p>
 * Copyright 2014 SSI Schaefer PEEM GmbH. All rights reserved.
 */

public final class ComplicatedOrderProcessor implements IProcessor {
  ...
  public boolean process(@Nonnull final IOrder order) {
    ...
    if (this.processed < this.limit && order.getType().equals("complicatedOrder")) {
      result = true;
      this.processed++;
    }
    return result;
...
//---------------------------- Revision History ----------------------------
//$Log: ComplicatedOrderProcessor.java,v $
