...
/**
 * <p>
 * SimpleOrder is a simple order implementation.
 * </p>
 * <p>
 * SimpleOrder is immutable and may be freely exchanged between threads. <br />
 * Calls to methods of SimpleOrder thread safe.
 * </p>
 * Copyright 2014 SSI Schaefer PEEM GmbH. All rights reserved.
 */

public final class SimpleOrder implements IOrder {
   ...
   */
  public SimpleOrder(@Nonnull final String id, @Nullable final String description, @Nullable final Object details) {
    checkNotNull(id, String.format(ERR_NOT_NULL, "id"));
    this.type = "simpleOrder";
    this.id = id;
