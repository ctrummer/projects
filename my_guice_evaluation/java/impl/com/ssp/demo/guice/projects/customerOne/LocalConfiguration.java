...
import com.ssp.demo.guice.projects.customerOne.implementation.AutoComparator;
import com.ssp.demo.guice.projects.customerOne.implementation.AutoProductProvider;
import com.ssp.demo.guice.projects.customerOne.implementation.AutoToString;
...
public class LocalConfiguration extends AbstractModule {
  ...
  protected final void configure() {
    ...
    bind(new TypeLiteral<Function<Product, String>>() {
      /** empty on purpose */
    }).annotatedWith(Names.named("convertProductToString")).to(AutoToString.class);
